...
public class Tipo_Cambio_BCNSoapProxy implements com.degomon.bcn.servicios.Tipo_Cambio_BCNSoap {
  private String _endpoint = null;
  private com.degomon.bcn.servicios.Tipo_Cambio_BCNSoap tipo_Cambio_BCNSoap = null;
  ...
  private void _initTipo_Cambio_BCNSoapProxy() {
    try {
      tipo_Cambio_BCNSoap = (new com.degomon.bcn.servicios.Tipo_Cambio_BCNLocator()).getTipo_Cambio_BCNSoap();
  ...
  public com.degomon.bcn.servicios.Tipo_Cambio_BCNSoap getTipo_Cambio_BCNSoap() {
    if (tipo_Cambio_BCNSoap == null)
      _initTipo_Cambio_BCNSoapProxy();
